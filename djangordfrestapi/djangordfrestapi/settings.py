"""
Django settings for djangordfrestapi project.
...
SECRET_KEY = 'django-insecure-6a^f9xca5y@@%7bv7z!)qtg#e99+a^nk)eh&r=bo4c59n!!9=a'
...
ROOT_URLCONF = 'djangordfrestapi.urls'
...
WSGI_APPLICATION = 'djangordfrestapi.wsgi.application'
